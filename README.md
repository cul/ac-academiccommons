...
11. (Optional, but recommended if writing any JavaScript) Run the typescript compiler to typecheck code and watch for changes. Typescript is not used for transpilation in this project, only static type checking.
   ```
   tsc --watch
   ```
