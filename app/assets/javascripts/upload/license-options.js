...
$(document).ready(function(){
  ...
  $('form#upload select#deposit_rights_statement').change(function() {
    ...
    if ($(this).val() === 'No Copyright') {
      ...
      addLicenseDropdown(div, licenses, 'Choose how other people use this work')
    }
  }).change();
});
