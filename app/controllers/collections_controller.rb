  ...
  CONFIG = {
    featured: {
      ...
      values: {
        ...
        'Community College Research Center'           => 'The Community College Research Center (CCRC) strategically assesses the problems and performance of community colleges in order to contribute to the development of practice and policy that expands access to higher education and promotes success for all students.',
