...
AcademicCommons::Application.configure do # rubocop:disable Metrics/BlockLength
  ...
  # ideal: no js compressor and no terser gem (IF WE NOT USING SPROCKETSo)
  # -- then, do we see any sprockets-compiled JS files (proj-root/tmp/cache/assets)
  # why is there content in public/assets and not just public/vite/assets
