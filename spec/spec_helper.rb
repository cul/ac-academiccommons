...
Capybara.register_driver :headless_chrome do |app|
  ...
  Capybara::Selenium::Driver.new(app, browser: :chrome, capabilities: all_capabilities)
end
...
=end
  ...
  # database. Feature tests use the :truncation policy. Using the :truncation
  # policy assures that the same db connection is used throughout the tests.
  config.before(:each) do
